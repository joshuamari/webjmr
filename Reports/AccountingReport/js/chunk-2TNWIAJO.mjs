var N = window,
  ...
  et = (r) => new S(typeof r == "string" ? r : r + "", void 0, M),
  j = (r, ...t) => {
    let e =
      r.length === 1
        ? r[0]
...
var B,
  T = window,
  ot = T.trustedTypes,
  xt = ot ? ot.emptyScript : "",
  it = T.reactiveElementPolyfillSupport,
  I = {
    toAttribute(r, t) {
      switch (t) {
        case Boolean:
  ...
  f = class extends HTMLElement {
        ...
        let s = i.getPropertyOptions(n),
          h =
            typeof s.converter == "function"
              ...
              : I;
        (this._$El = n),
          (this[n] = h.fromAttribute(e, s.type)),
          (this._$El = null);
      }
    }
    requestUpdate(t, e, o) {
      let i = !0;
      t !== void 0 &&
        (((o = o || this.constructor.getPropertyOptions(t)).hasChanged || rt)(
          this[t],
          e
        )
    ...
    performUpdate() {
      ...
      this.hasUpdated,
        this._$Ei &&
          (this._$Ei.forEach((i, n) => (this[n] = i)), (this._$Ei = void 0));
      let e = !1,
        o = this._$AL;
      try {
    ...
    _$AE(t) {
      ...
      (e = this._$ES) === null ||
        ...
        e.forEach((o) => {
          var i;
          return (i = o.hostUpdated) === null || i === void 0
            ? void 0
            : i.call(o);
        }),
    ...
    update(t) {
      this._$EC !== void 0 &&
        (this._$EC.forEach((e, o) => this._$EO(o, this[o], e)),
        (this._$EC = void 0)),
        this._$Ek();
    }
    updated(t) {}
...
(f[V] = !0),
  ...
  it == null || it({ ReactiveElement: f }),
  ((B = T.reactiveElementVersions) !== null && B !== void 0
    ? B
...
var K,
  z = window,
  y = z.trustedTypes,
  st = y ? y.createPolicy("lit-html", { createHTML: (r) => r }) : void 0,
  q = "$lit$",
  ...
  ut = Array.isArray,
  _t = (r) =>
    ut(r) || typeof (r == null ? void 0 : r[Symbol.iterator]) == "function",
  W = `[ 	
\f\r]`,
  E = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,
  nt = /-->/g,
...
\f\r"'\`<>=]|("|')|))|$)`,
  ...
  at = /'/g,
  ht = /"/g,
  vt = /^(?:script|style|textarea|title)$/i,
  ft =
    (r) =>
  ...
  ct = new WeakMap(),
  $ = m.createTreeWalker(m, 129, null, !1);
function gt(r, t) {
    ...
    for (let h = 0; h < e; h++) {
        ...
        (u = s.lastIndex),
          s === E
            ? c[1] === "!--"
              ...
              ? (s = lt)
              : c[2] !== void 0
              ? (vt.test(c[2]) && (i = RegExp("</" + c[2], "g")), (s = b))
              : c[3] !== void 0 && (s = b)
            : s === b
            ? c[0] === ">"
              ? ((s = i != null ? i : E), (p = -1))
              : c[1] === void 0
              ? (p = -2)
              : ((p = s.lastIndex - c[2].length),
                (a = c[1]),
                (s = c[3] === void 0 ? b : c[3] === '"' ? ht : at))
            : s === ht || s === at
            ? (s = b)
            : s === nt || s === lt
            ? (s = E)
      ...
      n +=
        s === E
          ? l + yt
          : p >= 0
          ? (o.push(a), l.slice(0, p) + q + l.slice(p) + g + v)
          : l + g + (p === -2 ? (o.push(void 0), h) : v);
    }
    return [gt(r, n + (r[e] || "<?>") + (t === 2 ? "</svg>" : "")), o];
  },
  U = class r {
    constructor({ strings: t, _$litType$: e }, o) {
      ...
      for (; (i = $.nextNode()) !== null && l.length < h; ) {
        if (i.nodeType === 1) {
            ...
            for (let u of i.getAttributeNames())
              if (u.endsWith(q) || u.startsWith(g)) {
                ...
                if ((p.push(u), v !== void 0)) {
                  let mt = i.getAttribute(v.toLowerCase() + q).split(g),
                    H = /([.?@])?(.*)/.exec(v);
                  l.push({
                    type: 1,
                    index: n,
          ...
          if (i.data === dt) l.push({ type: 2, index: n });
          else {
            let p = -1;
            for (; (p = i.data.indexOf(g, p + 1)) !== -1; )
              l.push({ type: 7, index: n }), (p += g.length - 1);
          }
        n++;
      }
    }
  ...
  let l =
      o !== void 0
        ? (i = e._$Co) === null || i === void 0
          ...
          : i[o]
        : e._$Cl,
    a = C(t) ? void 0 : t._$litDirective$;
  return (
    (l == null ? void 0 : l.constructor) !== a &&
      ((n = l == null ? void 0 : l._$AO) === null ||
        n === void 0 ||
        n.call(l, !1),
      a === void 0 ? (l = void 0) : ((l = new a(r)), l._$AT(r, e, o)),
      o !== void 0
        ? (((s = (h = e)._$Co) !== null && s !== void 0 ? s : (h._$Co = []))[
            o
          ] = l)
        : (e._$Cl = l)),
    l !== void 0 && (t = _(r, l._$AS(r, t.values), l, o)),
    t
  );
}
var J = class {
    ...
    u(t) {
      ...
      for (; a !== void 0; ) {
        if (h === a.index) {
          let c;
          a.type === 2
            ? (c = new P(s, s.nextSibling, this, t))
            : a.type === 1
            ? (c = new a.ctor(s, a.name, a.strings, this, t))
            : a.type === 6 && (c = new Q(s, this, t)),
            this._$AV.push(c),
            (a = i[++l]);
        }
  ...
  P = class r {
    constructor(t, e, o, i) {
      ...
      (this.type = 2),
        ...
        (this.options = i),
        (this._$Cp =
          (n = i == null ? void 0 : i.isConnected) === null ||
          n === void 0 ||
          n);
    }
    get _$AU() {
    ...
    g(t) {
      var e;
      let { values: o, _$litType$: i } = t,
        n =
          typeof i == "number"
            ? this._$AC(t)
            : (i.el === void 0 &&
                (i.el = U.createElement(gt(i.h, i.h[0]), this.options)),
              i);
    ...
    T(t) {
      ...
      for (let n of t)
        i === e.length
          ? e.push((o = new r(this.k(k()), this.k(k()), this, this.options)))
          : (o = e[i]),
          o._$AI(n),
          i++;
    ...
    _$AI(t, e = this, o, i) {
      ...
      if (n === void 0)
        ...
        for (t = n[0], l = 0; l < n.length - 1; l++)
          (a = _(this, h[o + l], e, l)),
            a === x && (a = this._$AH[l]),
            s || (s = !C(a) || a !== this._$AH[l]),
            a === d
              ? (t = d)
              : t !== d && (t += (a != null ? a : "") + n[l + 1]),
            (this._$AH[l] = a);
      }
      s && !i && this.j(t);
    }
...
pt == null || pt(U, P),
  ((K = z.litHtmlVersions) !== null && K !== void 0
    ? K
    : (z.litHtmlVersions = [])
  ).push("2.8.0");
var bt = (r, t, e) => {
...
(w.finalized = !0),
  ...
  (X = globalThis.litElementHydrateSupport) === null ||
    X === void 0 ||
    X.call(globalThis, { LitElement: w });
