...
function projRow(iVal){//lay project table
  ...
  if(ifEditable(iVal)){
    ...
    <td>
      <button class="btn btn-warning editProj"><i class='bx bx-edit fs-5' ></i></button>
      <button class="btn btn-danger delBut" data-bs-toggle="modal" data-bs-target="#deleteProjModal"><i class='bx bx-trash fs-5'></i></button>
    </td>`;
  }
  else{
